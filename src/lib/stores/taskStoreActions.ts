/**
 * CRUD operations for task store
 * Extracted to keep each module focused on a single responsibility
 */
 ...
 */
export function createMoveTask(
  get: () => TaskStoreState & { updateTask: (taskId: string, updates: Partial<Task>) => Promise<void> },
  set: StoreSetter
) {
 ...
 */
export function createMoveTaskToBoard(
  get: () => TaskStoreState & { updateTask: (taskId: string, updates: Partial<Task>) => Promise<void>; applyFilters: () => Promise<void> },
  set: StoreSetter
) {
 ...
 * Unarchives a task
 */
export function createUnarchiveTask(
  get: () => TaskStoreState & { updateTask: (taskId: string, updates: Partial<Task>) => Promise<void> },
  set: StoreSetter
) {
  return async (taskId: string) => {
